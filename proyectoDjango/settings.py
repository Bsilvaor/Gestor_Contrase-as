...
SECRET_KEY = 'django-insecure-*_eve=ur_&r%ano6950uh(3lca*11t5l35#lw7_8vm%v3o$r0x'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'gestorpass',          # Nombre de la base de datos que creaste
